...
var Twitch = require('./src/Twitch/Twitch.jsx')
...
var App = React.createClass({
  render: function () {
    return (
      <div>
        <Door color={'red'} onClick={showYoutube}><i className='fa fa-youtube-play fa-4x'></i><br/>Youtube</Door>
        <Door color={'blue'} onClick={showShutdown}><i className='fa fa-power-off fa-4x'></i><br/>Power</Door>
        <Door color={'purple'} onClick={showTwitch}><i className='fa fa-twitch fa-4x'></i><br/>Twitch</Door>
      </div>
    )
  }
})
